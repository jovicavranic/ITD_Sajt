...
if exist "C:\Bitnami\WORDPR~1.3-0\mariadb\scripts\servicerun.bat" (start "" /MIN "C:\Bitnami\WORDPR~1.3-0\mariadb\scripts\servicerun.bat" START)
...
if exist "C:\Bitnami\WORDPR~1.3-0\mariadb\scripts\servicerun.bat" (start "" /MIN "C:\Bitnami\WORDPR~1.3-0\mariadb\scripts\servicerun.bat" STOP)
